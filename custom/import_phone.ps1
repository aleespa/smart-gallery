...
# Thin wrapper over `smart-gallery import` (replaces custom/import_phone.py).
#
...
function Invoke-Import {
    ...
    # The catalog lives at the drive root that owns $Target (e.g. E:\ for E:\Photos\Other cameras).
